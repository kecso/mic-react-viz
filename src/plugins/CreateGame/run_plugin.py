"""
This script is called by the plugin-wrapper, CreateGame.js, which passes down the
...
plugin = CreateGame(webgme, COMMIT_HASH, BRANCH_NAME, ACTIVE_NODE_PATH, ACTIVE_SELECTION_PATHS, NAMESPACE)
